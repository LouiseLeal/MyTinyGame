...
(function (game) {
    ...
    var InputMovimentSystem = /** @class */ (function (_super) {
        __extends(InputMovimentSystem, _super);
        function InputMovimentSystem() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        InputMovimentSystem.prototype.OnUpdate = function () {
        ...
        InputMovimentSystem = __decorate([
            ut.executeAfter(ut.Shared.InputFence)
        ], InputMovimentSystem);
        return InputMovimentSystem;
    }(ut.ComponentSystem));
    game.InputMovimentSystem = InputMovimentSystem;
})(game || (game = {}));
var ut;
(function (ut) {
    /**
